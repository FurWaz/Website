<template>
    <div class="space-y-4">
        ...
        <p>We are FurWaz ("<b>Company</b>", "<b>we</b>", "<b>us</b>", "<b>our</b>"), a company registered in France at 6 Faubourg Saint Claude, Manonville, Grand Est 54 385.</p>
        ...
        <p>You can contact us by phone at 0782582541, email at contact@furwaz.fr, or by mail to 6 Faubourg Saint Claude, Manonville, Grand Est 54 385, France.</p>
        ...
        <p>
            ...
            <a href="#purchases">6. PURCHASES AND PAYMENT</a> <br>
            <a href="#returnno">7. REFUNDS POLICY</a> <br>
            <a href="#software">8. SOFTWARE</a> <br>
            <a href="#prohibited">9. PROHIBITED ACTIVITIES</a> <br>
            <a href="#ugc">10. USER GENERATED CONTRIBUTIONS</a> <br>
            <a href="#license">11. CONTRIBUTION LICENSE</a> <br>
            <a href="#reviews">12. GUIDELINES FOR REVIEWS</a> <br>
            <a href="#thirdparty">13. THIRD-PARTY WEBSITES AND CONTENT</a> <br>
            <a href="#advertiser">14. ADVERTISERS</a> <br>
            <a href="#sitemanage">15. SERVICES MANAGEMENT</a> <br>
            <a href="#ppyes">16. PRIVACY POLICY</a> <br>
            <a href="#copyrightno">17. COPYRIGHT INFRINGEMENTS</a> <br>
            <a href="#terms">18. TERM AND TERMINATION</a> <br>
            <a href="#modifications">19. MODIFICATIONS AND INTERRUPTIONS</a> <br>
            <a href="#law">20. GOVERNING LAW</a> <br>
            <a href="#disputes">21. DISPUTE RESOLUTION</a> <br>
            <a href="#corrections">22. CORRECTIONS</a> <br>
            <a href="#disclaimer">23. DISCLAIMER</a> <br>
            <a href="#liability">24. LIMITATIONS OF LIABILITY</a> <br>
            <a href="#indemnification">25. INDEMNIFICATION</a> <br>
            <a href="#userdata">26. USER DATA</a> <br>
            <a href="#electronic">27. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a> <br>
            <a href="#misc">28. MISCELLANEOUS</a> <br>
            <a href="#contact">29. CONTACT US</a> <br>
        </p>


        <span class="break" />

        <h1 id="services">1. OUR SERVICES</h1>

        <p>The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.</p>

        <span class="break" />

        <h1 id="ip">2. INTELLECTUAL PROPERTY RIGHTS</h1>
        ...
        <p>
            <b>When you post Contributions, you grant us a license (including use of your name, trademarks, and logos):</b>
            <br>
        ...
        <p>
            <b>We may remove or edit your Content:</b>
            <br>
        ...
        <h1 id="userreps">3. USER REPRESENTATIONS</h1>
        ...
        <h1 id="userreg">4. USER REGISTRATION</h1>
        ...
        <h1 id="purchases">6. PURCHASES AND PAYMENT</h1>
        ...
        <h1 id="returnno">7. REFUNDS POLICY</h1>

        <p>All sales are final and no refund will be issued.</p>

        <span class="break" />

        <h1 id="software">8. SOFTWARE</h1>
        ...
        <h1 id="prohibited">9. PROHIBITED ACTIVITIES</h1>
        ...
        <h1 id="ugc">10. USER GENERATED CONTRIBUTIONS</h1>
        ...
        <h1 id="license">11. CONTRIBUTION LICENSE</h1>
        ...
        <h1 id="reviews">12. GUIDELINES FOR REVIEWS</h1>
        ...
        <h1 id="thirdparty">13. THIRD-PARTY WEBSITES AND CONTENT</h1>
        ...
        <h1 id="advertiser">14. ADVERTISERS</h1>
        ...
        <h1 id="sitemanage">15. SERVICES MANAGEMENT</h1>
        ...
        <h1 id="copyrightno">17. COPYRIGHT INFRINGEMENTS</h1>
        ...
        <h1 id="terms">18. TERM AND TERMINATION</h1>
        ...
        <h1 id="modifications">19. MODIFICATIONS AND INTERRUPTIONS</h1>
        ...
        <h1 id="law">20. GOVERNING LAW</h1>

        <p>These Legal Terms are governed by and interpreted following the laws of France, and the use of the United Nations Convention of Contracts for the International Sales of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law in your country to residence. FurWaz and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Grand Est, which means that you may make a claim to defend your consumer protection rights in regards to these Legal Terms in France, or in the EU country in which you reside.</p>

        <span class="break" />

        <h1 id="disputes">21. DISPUTE RESOLUTION</h1>

        <p><b>Informal Negotiations</b></p>
        ...
        <h1 id="corrections">22. CORRECTIONS</h1>

        <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>

        <span class="break" />

        <h1 id="disclaimer">23. DISCLAIMER</h1>
        ...
        <h1 id="liability">24. LIMITATIONS OF LIABILITY</h1>

        <p>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>

        <span class="break" />

        <h1 id="indemnification">25. INDEMNIFICATION</h1>
        ...
        <h1 id="misc">28. MISCELLANEOUS</h1>
        ...
        <h1 id="contact">29. CONTACT US</h1>
