<template>
    <div class="space-y-4">
        ...
        <p>
            ...
            <a href="#ifouse">2. HOW DO WE PROCESS YOUR INFORMATION?</a> <br>
            ...
            <a href="#3pwebsites">5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</a> <br>
            <a href="#sociallogins">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a> <br>
            <a href="#inforetain">7. HOW LONG DO WE KEEP YOUR INFORMATION?</a> <br>
            <a href="#infosafe">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</a> <br>
            <a href="#infominors">9. DO WE COLLECT INFORMATION FROM MINORS?</a> <br>
            <a href="#privacyights">10. WHAT ARE YOUR PRIVACY RIGHTS?</a> <br>
            <a href="#DNT">11. CONTROLS FOR DO-NOT-TRACK FEATURES</a> <br>
            <a href="#policyupdates">12. DO WE MAKE UPDATES TO THIS NOTICE?</a> <br>
            <a href="#contact">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a> <br>
            <a href="#request">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a> <br>
        </p>

        <span class="break" />

        <h1 id="infocollect">1. WHAT INFORMATION DO WE COLLECT?</h1>
        ...
        <h1 id="ifouse">2. HOW DO WE PROCESS YOUR INFORMATION?</h1>
        ...
        <ul>
            ...
            <li>
                ...
                <br>
                We may process your information when necessary to save or protect an individual’s vital interest, such as to prevent harm.</li>
        </ul>

        <span class="break" />

        <h1 id="legalbases">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h1>
        ...
        <h1 id="whoshare">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h1>
        ...
        <h1 id="sociallogins">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h1>
        ...
        <h1 id="inforetain">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h1>
        ...
        <h1 id="infosafe">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h1>
        ...
        <h1 id="infominors">9. DO WE COLLECT INFORMATION FROM MINORS?</h1>
        ...
        <h1 id="privacyights">10. WHAT ARE YOUR PRIVACY RIGHTS?</h1>
        ...
        <h1 id="policyupdates">12. DO WE MAKE UPDATES TO THIS NOTICE?</h1>
