<template>
    <div class="fixed z-50 w-screen h-fit">
        <div class="flex flex-col grow h-fit m-4 rounded-lg shadow-xl p-2 bg-slate-700 border-2 border-slate-600">
            ...
            <div ref="mobile-menu" class="flex flex-col grow h-fit overflow-hidden transition-all duration-500" style="max-height: 0px;">
                <div class="flex flex-col grow">
                    <span class="flex grow h-[2px] bg-slate-500 rounded mx-4 mt-2"></span>
                    ...
                    <span class="flex grow h-[2px] bg-slate-600 rounded w-12 mx-auto"></span>
                    <div class="flex grow mt-4">
                        ...
                        <div v-if="User.CurrentUser != null" class="flex grow justify-evenly space-x-4 mb-2">
                            <button-text :action="disconnect"> Disconnect </button-text>
                            <button-block href="/profile"> Profile </button-block>
                        </div>
                    </div>
                </div>
            </div>
...
function setup(page) {
    page.$refs["menu-btn"].addEventListener("click", () => {
        // on recupere le menu mobile
        const mobile_menu = page.$refs["mobile-menu"];
