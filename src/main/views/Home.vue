<template>
    <div class="relative flex grow overflow-x-hidden">
        ...
        <div class="flex flex-col grow w-full" style="z-index: 1;">
            <div ref="title"  class="flex flex-col grow justify-center my-20">
                <div style="animation-delay: 300ms" class="show-up noscroll opacity-0 flex justify-center mx-auto transition-all dark:text-slate-50 text-slate-700">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 250 250" stroke-width="14" stroke="currentColor" class="md:h-80 h-40 drop-shadow-xl">
                        <path d="M-45,34"/>
                        <path d="M144,52"/>
                        <path d="M198,196"/>
                        <path d="M36,70"/>
                ...
                <div class="flex flex-col justify-center mx-auto">
                    <h1 style="animation-delay: 200ms" class="show-down noscroll md:text-[8em] text-[4em] font-extrabold drop-shadow-xl bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-orange-500 m-0"> FurWaz </h1>
                </div>
            </div>
