...
const projects: Project[] = [
    ...
    },
    {
        name: 'AlgoSnipper',
        description: {
            fr: 'Une extension pour VS Code pour l\'algorithmique a l\'IUT Charlemagne !',
            en: 'A VS Code extension for algorithmic programming at the Charlemagne IT Department!',
        },
        explanation: {
            fr: [
                "AlgoSniper est une extension pour VS Code qui vous permet de coder dans le langage algorithmique utilisé pour l'apprentissage de la programmation au département informatique de Charlemagne.",
